...
# Creating Agnostic encoding string
datastring = ""
for w in str_predictions[0]:
    datastring += int2word[w] + " "
    #print(int2word[w])
    #print("\t")

# Calling musescore442 to convert to TinyNotation and open in MuseScore
import musescore442
musescore442.ShowMuseScore(datastring)
